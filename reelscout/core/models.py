...
class ScrapedReel(models.Model):
    ...
    # 👇 Essential for Whisper to access the audio
    ...
    # Updated schema representation for accurate time tracking
    comments_dump = models.JSONField(default=list, blank=True, null=True, help_text="Schema: [{'text': '...', 'likes': 0, 'date': '...'}]")
    ...
    extracted_general_info = models.JSONField(default=dict, blank=True, null=True, help_text="Subjective info strictly from this reel")
    extracted_known_facts = models.JSONField(default=dict, blank=True, null=True, help_text="Objective facts strictly from this reel")
...
# Stores the extracted frames for Gemini
